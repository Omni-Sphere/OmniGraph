...
service::ResolverMap UserMutation::getResolvers() const noexcept
{
	return {
		...
		{ R"gql(ChangePassword)gql"sv, [this](service::ResolverParams&& params) { return resolveChangePassword(std::move(params)); } },
		{ R"gql(UpdateUserPolicies)gql"sv, [this](service::ResolverParams&& params) { return resolveUpdateUserPolicies(std::move(params)); } }
	};
}
...
{
	auto argUser = service::ModifiedArgument<omnisphere::CreateUserInput>::require("User", params.arguments);
...
{
	auto argUser = service::ModifiedArgument<omnisphere::UpdateUserInput>::require("User", params.arguments);
	std::unique_lock resolverLock(_resolverMutex);
	service::SelectionSetParams selectionSetParams { static_cast<const service::SelectionSetParams&>(params) };
	auto directives = std::move(params.fieldDirectives);
...
service::AwaitableResolver UserMutation::resolveChangePassword(service::ResolverParams&& params) const
{
	auto argUser = service::ModifiedArgument<ChangePasswordInput>::require("User", params.arguments);
	std::unique_lock resolverLock(_resolverMutex);
	service::SelectionSetParams selectionSetParams { static_cast<const service::SelectionSetParams&>(params) };
	auto directives = std::move(params.fieldDirectives);
	auto result = _pimpl->getChangePassword(service::FieldParams { std::move(selectionSetParams), std::move(directives) }, std::move(argUser));
	resolverLock.unlock();

	return service::ModifiedResult<bool>::convert(std::move(result), std::move(params));
}

service::AwaitableResolver UserMutation::resolveUpdateUserPolicies(service::ResolverParams&& params) const
{
	auto argPolicies = service::ModifiedArgument<UpdateUserPoliciesInput>::require("Policies", params.arguments);
	std::unique_lock resolverLock(_resolverMutex);
	service::SelectionSetParams selectionSetParams { static_cast<const service::SelectionSetParams&>(params) };
	auto directives = std::move(params.fieldDirectives);
	auto result = _pimpl->getUpdateUserPolicies(service::FieldParams { std::move(selectionSetParams), std::move(directives) }, std::move(argPolicies));
	resolverLock.unlock();
...
void AddUserMutationDetails(const std::shared_ptr<schema::ObjectType>& typeUserMutation, const std::shared_ptr<schema::Schema>& schema)
{
	typeUserMutation->AddFields({
		schema::Field::Make(R"gql(CreateUser)gql"sv, R"md()md"sv, std::nullopt, schema->WrapType(introspection::TypeKind::NON_NULL, schema->LookupType(R"gql(User)gql"sv)), {
		...
		schema::Field::Make(R"gql(UpdateUser)gql"sv, R"md()md"sv, std::nullopt, schema->WrapType(introspection::TypeKind::NON_NULL, schema->LookupType(R"gql(User)gql"sv)), {
		...
		schema::Field::Make(R"gql(ChangePassword)gql"sv, R"md()md"sv, std::nullopt, schema->WrapType(introspection::TypeKind::NON_NULL, schema->LookupType(R"gql(Boolean)gql"sv)), {
		...
		schema::Field::Make(R"gql(UpdateUserPolicies)gql"sv, R"md()md"sv, std::nullopt, schema->WrapType(introspection::TypeKind::NON_NULL, schema->LookupType(R"gql(Boolean)gql"sv)), {
			schema::InputValue::Make(R"gql(Policies)gql"sv, R"md()md"sv, schema->WrapType(introspection::TypeKind::NON_NULL, schema->LookupType(R"gql(UpdateUserPoliciesInput)gql"sv)), R"gql()gql"sv)
		})
	});
}
